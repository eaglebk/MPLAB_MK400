/*-------------------------------------------------------------------------
 * $Id: p18f6720.h,v 1.1 2003/12/09 22:54:19 GrosbaJ Exp $
...
extern				unsigned	char		PAR1;
extern				unsigned	short		SHORT_PAR1;
extern							void		*PTR_PAR1;
extern				unsigned	char		PAR2;
extern							void		*PTR_PAR2;
extern				unsigned	char		PAR3;
extern				unsigned	short		SHORT_PAR3;
extern							void		*PTR_PAR3;
extern				unsigned	char		PAR4;
extern				unsigned	char		PAR5;
extern				unsigned	short		SHORT_PAR5;
extern				unsigned	char		PAR6;
extern				unsigned	char		PAR7;
extern				unsigned	char		PAR8;
extern				unsigned	char		PAR9;
extern				unsigned	char		PAR10;
extern				unsigned	char		PAR11;
extern				unsigned	char		PAR12;
extern				unsigned	char		PAR13;
extern				unsigned	char		PAR14;
extern				unsigned	char		PAR15;
extern				unsigned	char		PAR16;
...
struct PortHeader {
	...
	extern	void mod_id_app(void);
	extern	unsigned char get_scan_status(void);
	extern	unsigned char get_modbus_reg(unsigned short mb_adr, void *ptr_buf,unsigned char num);
	extern	unsigned char set_modbus_reg(unsigned short mb_adr,void *ptr_buf,unsigned char num);
	extern	void swap_reg(void *ptr_buf,unsigned char num);
	extern	unsigned char get_modbus_bit(unsigned short mb_adr,void *ptr_buf,unsigned char num);
	extern	unsigned char set_modbus_bit(unsigned short mb_adr,void *ptr_buf,unsigned char num);
	extern	void lock_shared_resource(void);
	extern	void unlock_shared_resource(void);
	extern	void get_operative_time(void *ptr_buf);
	extern	void set_operative_time(void *ptr_buf);
	extern	unsigned short get_powersafe_reg3(void);
	extern	void set_powersafe_reg3(unsigned short s_val);
	extern	unsigned short get_powersafe_reg4(void);
	extern	void set_powersafe_reg4(unsigned short s_val);
	extern	unsigned short get_counter10ms(void);
	extern	unsigned char get_counter1s(void);
	extern	void set_record_to_arhiv(unsigned short mb_adr,unsigned char data_type,unsigned char num);
	extern 	float iee2mcflo(float val);
	extern	float mcflo2iee(float val);
/*void fxd3216u(void);
void fxd2416u(void);
void fxd1608u(void);
void fxm32_8(void);
...
void bcd2hex(void);
void hex2bcd(void);
void word2float(void);
void fps32(void);
void fpa32(void);*/
//Port1
	extern	unsigned char open_port1(struct PortHeader *ptr_PortHeader);
	extern	unsigned char get_ptr_buffer_port1(struct PortHeader *ptr_PortHeader);
	extern	unsigned char begin_transaction_port1(struct PortHeader *ptr_PortHeader);
	extern	unsigned char get_status_transaction_port1(struct PortHeader *ptr_PortHeader);
	extern	unsigned char close_port1(void);
//Port2
	extern	unsigned char open_port2(struct PortHeader *ptr_PortHeader);
	extern	unsigned char get_ptr_buffer_port2(struct PortHeader *ptr_PortHeader);
	extern	unsigned char begin_transaction_port2(struct PortHeader *ptr_PortHeader);
	extern	unsigned char get_status_transaction_port2(struct PortHeader *ptr_PortHeader);
	extern	unsigned char close_port2(void);
